...
import asyncio
from index import main, report_events_async, get_amount_of_threads, init_args, write_commands_to_file
import os
...
class TestAuthLogAnalyzer(unittest.TestCase):
    ...
    def test_main(self, mock_init_args, mock_get_amount_of_threads, mock_asyncio_run, mock_AuthLogAnalyzer, mock_initialize_logging, mock_run_car):
        mock_args = MagicMock()
    ...
    def test_report_events_async(self, mock_tqdm, mock_ClientSession):
        ...
        mock_tqdm.asyncio.as_completed.return_value = [asyncio.Future(), asyncio.Future()]
